...
var Web3ContractCache = /** @class */ (function () {
     ...
     */
    Web3ContractCache.prototype.getContract = function (contract) {
        return __awaiter(this, void 0, void 0, function () {
            var createFn, _a, _b, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        if (!(this.cacheMap[contract] == null)) return [3 /*break*/, 2];
                        debug('Initiating contract %s', contract);
                        createFn = ContractFactories[contract];
