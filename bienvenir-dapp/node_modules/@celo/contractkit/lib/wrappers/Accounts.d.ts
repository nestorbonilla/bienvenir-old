...
export declare class AccountsWrapper extends BaseWrapper<Accounts> {
    ...
    generateProofOfSigningKeyPossession(account: Address, signer: Address): Promise<{
        v: number;
        r: string;
        s: string;
    }>;
    generateProofOfSigningKeyPossessionLocally(account: Address, signer: Address, privateKey: string): Promise<{
        v: number;
        r: string;
        s: string;
    }>;
     ...
     */
    setAccount: (name: string, dataEncryptionKey: (string | number[])[], walletAddress: string) => CeloTransactionObject<void>;
    /**
     ...
     */
    setWalletAddress: (walletAddress: string) => CeloTransactionObject<void>;
