...
var DoubleSigningSlasherWrapper = /** @class */ (function (_super) {
    ...
    function DoubleSigningSlasherWrapper() {
         ...
         * @return Block number.
         */
        _this.getBlockNumberFromHeader = BaseWrapper_1.proxyCall(_this.contract.methods.getBlockNumberFromHeader, undefined, BaseWrapper_1.valueToInt);
        return _this;
    }
    /**
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 8:
                        lockedGold = _a.sent();
                        return [4 /*yield*/, lockedGold.computeParametersForSlashing(validator.address, incentives.penalty)];
                    case 9:
                        slashValidator = _a.sent();
                        return [4 /*yield*/, lockedGold.computeParametersForSlashing(membership.group, incentives.penalty)];
                    case 10:
                        slashGroup = _a.sent();
