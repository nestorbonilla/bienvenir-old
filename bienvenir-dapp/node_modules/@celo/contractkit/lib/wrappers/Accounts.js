...
var AccountsWrapper = /** @class */ (function (_super) {
    ...
    function AccountsWrapper() {
         ...
         */
        _this.getDataEncryptionKey = BaseWrapper_1.proxyCall(_this.contract.methods.getDataEncryptionKey);
        /**
         ...
         */
        _this.setWalletAddress = BaseWrapper_1.proxySend(_this.kit, _this.contract.methods.setWalletAddress);
        return _this;
    }
    /**
     ...
     */
    AccountsWrapper.prototype.signerToAccount = function (signer, blockNumber) {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                ...
                                metadataURL: ret[4],
                                wallet: ret[5],
                                dataEncryptionKey: BaseWrapper_1.bytesToString(ret[6]),
                            }];
                }
            });
        });
                ...
                switch (_b.label) {
                    ...
                    case 4:
                        if (_b.sent()) {
                            ...
                            return [2 /*return*/, BaseWrapper_1.toTransactionObject(this.kit, this.contract.methods.authorizeValidatorSignerWithPublicKey(signer, proofOfSigningKeyPossession.v, proofOfSigningKeyPossession.r, proofOfSigningKeyPossession.s, BaseWrapper_1.stringToBytes(pubKey)))];
                        }
                        else {
    ...
    AccountsWrapper.prototype.generateProofOfSigningKeyPossession = function (account, signer) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    AccountsWrapper.prototype.generateProofOfSigningKeyPossessionLocally = function (account, signer, privateKey) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
