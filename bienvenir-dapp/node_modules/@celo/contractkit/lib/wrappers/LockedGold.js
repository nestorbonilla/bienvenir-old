...
var LockedGoldWrapper = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1: return [2 /*return*/, (_a.unlockingPeriod = _b.apply(void 0, [_c.sent()]),
                            _a)];
                }
            });
        });
     ...
     */
    LockedGoldWrapper.prototype.computeParametersForSlashing = function (account, penalty) {
        return __awaiter(this, void 0, void 0, function () {
            var election, eligible, groups, changed, changes;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.computeDecrementsForSlashing(account, penalty)];
                    case 3:
                        changed = _a.sent();
    ...
    LockedGoldWrapper.prototype.computeDecrementsForSlashing = function (account, penalty) {
        return __awaiter(this, void 0, void 0, function () {
            var nonVoting, difference, election, groups, res, i, group, totalVotes, votes, slashedVotes;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getAccountNonvotingLockedGold(account)];
                    case 1:
