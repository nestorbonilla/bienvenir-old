...
var ElectionWrapper = /** @class */ (function (_super) {
    ...
    function ElectionWrapper() {
         ...
         */
        _this.electabilityThreshold = BaseWrapper_1.proxyCall(_this.contract.methods.getElectabilityThreshold, undefined, BaseWrapper_1.valueToBigNumber);
        /**
         ...
         */
        _this.electValidatorSigners = BaseWrapper_1.proxyCall(_this.contract.methods.electValidatorSigners);
        /**
     ...
     */
    ElectionWrapper.prototype.getCurrentValidatorSigners = function (blockNumber) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                // @ts-ignore: Expected 0-1 arguments, but got 2
                return [2 /*return*/, this.contract.methods.getCurrentValidatorSigners().call({}, blockNumber)];
            });
        });
    };
    /**
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        // re-sort
                        currentVotes.sort(function (a, b) { return a.votes.comparedTo(b.votes); });
                        newIdx = currentVotes.findIndex(function (votes) { return address_1.eqAddress(votes.address, votedGroup); });
                        return [2 /*return*/, {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        blockNumber = _a.sent();
                        return [4 /*yield*/, this.getCurrentValidatorSigners(blockNumber)];
                    case 2:
                        signers = _a.sent();
                        return [4 /*yield*/, this.kit.contracts.getValidators()];
                    case 3:
                        validators = _a.sent();
                        return [2 /*return*/, async_1.concurrentMap(10, signers, function (addr) {
                                return validators.getValidatorFromSigner(addr, blockNumber);
                            })];
                }
            });
        });
     ...
     */
    ElectionWrapper.prototype.getVoterRewards = function (address, epochNumber) {
        return __awaiter(this, void 0, void 0, function () {
            var blockNumber, voter, activeVoterVotes, _i, _a, vote, group, activeGroupVotes, groupVoterRewards, voterRewards;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.kit.getLastBlockNumberForEpoch(epochNumber)];
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, async_1.concurrentValuesMap(10, activeVoterVotes, function (_, group) { return _this.getTotalVotesForGroup(group, blockNumber); })];
                    case 3:
                        activeGroupVotes = _b.sent();
                        return [4 /*yield*/, this.getGroupVoterRewards(epochNumber)];
                    case 4:
                        groupVoterRewards = _b.sent();
                        voterRewards = groupVoterRewards.filter(function (e) { return address_1.normalizeAddress(e.group.address) in activeVoterVotes; });
                        return [2 /*return*/, voterRewards.map(function (e) {
                                var group = address_1.normalizeAddress(e.group.address);
                                return {
                                    address: address,
                                    addressPayment: e.groupVoterPayment.times(activeVoterVotes[group].dividedBy(activeGroupVotes[group])),
                                    group: e.group,
