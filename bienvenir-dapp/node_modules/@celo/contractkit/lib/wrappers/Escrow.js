...
var EscrowWrapper = /** @class */ (function (_super) {
    ...
    function EscrowWrapper() {
        ...
        _this.getReceivedPaymentIds = BaseWrapper_1.proxyCall(_this.contract.methods.sentPaymentIds);
        _this.getSentPaymentId = BaseWrapper_1.proxyCall(_this.contract.methods.sentPaymentIds);
