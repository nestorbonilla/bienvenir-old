...
export declare class GoldTokenWrapper extends BaseWrapper<GoldToken> {
     ...
     */
    allowance: (owner: string, spender: string) => Promise<_>;
    /**
     ...
     */
    increaseAllowance: (spender: string, value: string | number) => import("./BaseWrapper").CeloTransactionObject<boolean>;
    /**
     ...
     */
    balanceOf: (account: string) => Promise<_>;
}
