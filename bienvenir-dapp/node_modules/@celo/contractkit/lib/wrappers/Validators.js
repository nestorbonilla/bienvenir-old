...
var ValidatorsWrapper = /** @class */ (function (_super) {
    ...
    function ValidatorsWrapper() {
         ...
         */
        _this.updateBlsPublicKey = BaseWrapper_1.proxySend(_this.kit, _this.contract.methods.updateBlsPublicKey, BaseWrapper_1.tupleParser(BaseWrapper_1.stringToBytes, BaseWrapper_1.stringToBytes));
        /**
        ...
        _this.registerValidator = BaseWrapper_1.proxySend(_this.kit, _this.contract.methods.registerValidator, BaseWrapper_1.tupleParser(BaseWrapper_1.stringToBytes, BaseWrapper_1.stringToBytes, BaseWrapper_1.stringToBytes));
        /**
    ...
    ValidatorsWrapper.prototype.updateCommission = function (commission) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, BaseWrapper_1.toTransactionObject(this.kit, this.contract.methods.updateCommission(fixidity_1.toFixed(commission).toFixed()))];
            });
        });
    };
    /**
     ...
     * @return The associated account.
     */
    ValidatorsWrapper.prototype.signerToAccount = function (signerAddress, blockNumber) {
        return __awaiter(this, void 0, void 0, function () {
            var accounts;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        accounts = _a.sent();
                        return [2 /*return*/, accounts.signerToAccount(signerAddress, blockNumber)];
                }
            });
        });
    };
    ...
    ValidatorsWrapper.prototype.getValidatorFromSigner = function (address, blockNumber) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.signerToAccount(address, blockNumber)];
                    case 1:
                        account = _a.sent();
                ...
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        affiliates = validators
                            .filter(function (v) { return v.affiliation === address; })
                    ...
                    case 5: return [2 /*return*/, {
                            ...
                            address: address,
                            members: res[0],
                            membersUpdated: res[2].reduce(function (a, b) { return Math.max(a, new bignumber_js_1.default(b).toNumber()); }, 0),
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        idx = allValidators.findIndex(function (addr) { return address_1.eqAddress(validatorAddress, addr); });
                        if (idx < 0) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        allGroups = _a.sent();
                        idx = allGroups.findIndex(function (addr) { return address_1.eqAddress(validatorGroupAddress, addr); });
                        if (idx < 0) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        currentIdx = group.members.map(address_1.normalizeAddress).indexOf(address_1.normalizeAddress(validator));
                        if (currentIdx < 0) {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, async_1.concurrentMap(10, events, function (e) {
                                return _this.getValidator(e.returnValues.validator, blockNumber);
                            })];
                    case 3:
                        validator = _a.sent();
                        return [4 /*yield*/, async_1.concurrentMap(10, events, function (e) {
                                return _this.getValidatorGroup(e.returnValues.group, false, blockNumber);
                            })];
                    case 4:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, async_1.concurrentMap(5, signerAddresses, this.validatorSignerToAccount)];
                    case 2:
    ...
    ValidatorsWrapper.prototype.findValidatorMembershipHistoryIndex = function (epoch, history) {
        return history.reverse().findIndex(function (x) { return x.epoch <= epoch; });
    };
