...
var GasPriceMinimumWrapper = /** @class */ (function (_super) {
    ...
    function GasPriceMinimumWrapper() {
         ...
         */
        _this.targetDensity = BaseWrapper_1.proxyCall(_this.contract.methods.targetDensity, undefined, BaseWrapper_1.valueToBigNumber);
        /**
         * Query adjustment speed parameter
         * @returns multiplier that impacts how quickly gas price minimum is adjusted.
         */
        _this.adjustmentSpeed = BaseWrapper_1.proxyCall(_this.contract.methods.adjustmentSpeed, undefined, BaseWrapper_1.valueToBigNumber);
        return _this;
    }
    /**
