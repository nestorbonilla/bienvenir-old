...
function verifyKeybaseClaim(claim, signer) {
    return __awaiter(this, void 0, void 0, function () {
        var resp, jsonResp, parsedClaim, hasValidSiganture, parsedKeybaseClaim, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    hasValidSiganture = signatureUtils_1.verifySignature(claim_1.hashOfClaim(parsedClaim.right.claim), parsedClaim.right.signature, signer);
                    if (!hasValidSiganture) {
                        return [2 /*return*/, 'Claim does not contain a valid signature'];
                    }
                    parsedKeybaseClaim = exports.KeybaseClaimType.decode(parsedClaim.right.claim);
