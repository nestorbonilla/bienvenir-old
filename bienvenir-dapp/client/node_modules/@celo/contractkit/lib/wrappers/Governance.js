...
exports.proposalToParams = function (proposal, descriptionURL) {
    var data = proposal.map(function (tx) { return BaseWrapper_1.stringToBuffer(tx.input); });
    return [
        proposal.map(function (tx) { return tx.value; }),
        proposal.map(function (tx) { return tx.to; }),
        BaseWrapper_1.bufferToBytes(Buffer.concat(data)),
...
exports.hotfixToParams = function (proposal, salt) {
    ...
    return [p[0], p[1], p[2], p[3], BaseWrapper_1.bufferToString(salt)];
};
...
var GovernanceWrapper = /** @class */ (function (_super) {
    ...
    function GovernanceWrapper() {
        ...
        _this.getProposalTransaction = BaseWrapper_1.proxyCall(_this.contract.methods.getProposalTransaction, BaseWrapper_1.tupleParser(BaseWrapper_1.valueToString, BaseWrapper_1.valueToString), function (res) { return ({
            value: res[0],
            to: res[1],
            input: BaseWrapper_1.bytesToString(res[2]),
        }); });
        /**
         ...
         */
        _this.isHotfixWhitelistedBy = BaseWrapper_1.proxyCall(_this.contract.methods.isHotfixWhitelistedBy, BaseWrapper_1.tupleParser(BaseWrapper_1.bufferToString, function (s) { return BaseWrapper_1.identity(s); }));
        /**
         * Returns whether a given hotfix can be passed.
         * @param hash keccak256 hash of hotfix's associated abi encoded transactions
         */
        _this.isHotfixPassing = BaseWrapper_1.proxyCall(_this.contract.methods.isHotfixPassing, BaseWrapper_1.tupleParser(BaseWrapper_1.bufferToString));
        /**
         * Returns the number of validators required to reach a Byzantine quorum
         */
        _this.byzantineQuorumValidators = BaseWrapper_1.proxyCall(_this.contract.methods.byzantineQuorumValidatorsInCurrentSet, undefined, BaseWrapper_1.valueToBigNumber);
        /**
         * Returns the number of validators that whitelisted the hotfix
         * @param hash keccak256 hash of hotfix's associated abi encoded transactions
         */
        _this.hotfixWhitelistValidatorTally = BaseWrapper_1.proxyCall(_this.contract.methods.hotfixWhitelistValidatorTally, BaseWrapper_1.tupleParser(BaseWrapper_1.bufferToString));
        /**
         * Marks the given hotfix whitelisted by `sender`.
         * @param hash keccak256 hash of hotfix's associated abi encoded transactions
         */
        _this.whitelistHotfix = BaseWrapper_1.proxySend(_this.kit, _this.contract.methods.whitelistHotfix, BaseWrapper_1.tupleParser(BaseWrapper_1.bufferToString));
        /**
         * Marks the given hotfix approved by `sender`.
         * @param hash keccak256 hash of hotfix's associated abi encoded transactions
         * @notice Only the `approver` address will succeed in sending this transaction
         */
        _this.approveHotfix = BaseWrapper_1.proxySend(_this.kit, _this.contract.methods.approveHotfix, BaseWrapper_1.tupleParser(BaseWrapper_1.bufferToString));
        /**
         * Marks the given hotfix prepared for current epoch if quorum of validators have whitelisted it.
         * @param hash keccak256 hash of hotfix's associated abi encoded transactions
         */
        _this.prepareHotfix = BaseWrapper_1.proxySend(_this.kit, _this.contract.methods.prepareHotfix, BaseWrapper_1.tupleParser(BaseWrapper_1.bufferToString));
        /**
    ...
    GovernanceWrapper.prototype.timeUntilStages = function (proposalID) {
        return __awaiter(this, void 0, void 0, function () {
            var meta, durations, referendum, execution, expiration;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        expiration = referendum.plus(durations.Execution);
    ...
    GovernanceWrapper.prototype.getProposalRecord = function (proposalID) {
        return __awaiter(this, void 0, void 0, function () {
            var metadata, proposal, stage, upvotes, votes;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.getProposalMetadata(proposalID)];
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 7];
                    case 5:
                        if (!(stage !== ProposalStage.Expiration)) return [3 /*break*/, 7];
    ...
    GovernanceWrapper.prototype.getHotfixRecord = function (hash) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contract.methods.getHotfixRecord(BaseWrapper_1.bufferToString(hash)).call()];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, {
                                approved: res[0],
