...
var ExchangeWrapper = /** @class */ (function (_super) {
    ...
    function ExchangeWrapper() {
         ...
         */
        _this.spread = BaseWrapper_1.proxyCall(_this.contract.methods.spread, undefined, BaseWrapper_1.valueToBigNumber);
        /**
         * Query reserve fraction parameter
         * @returns Current fraction to commit to the gold bucket
         */
        _this.reserveFraction = BaseWrapper_1.proxyCall(_this.contract.methods.reserveFraction, undefined, BaseWrapper_1.valueToBigNumber);
        /**
         ...
         */
        _this.getBuyTokenAmount = BaseWrapper_1.proxyCall(_this.contract.methods.getBuyTokenAmount, BaseWrapper_1.tupleParser(BaseWrapper_1.valueToString, BaseWrapper_1.identity), BaseWrapper_1.valueToBigNumber);
        /**
         ...
         */
        _this.getSellTokenAmount = BaseWrapper_1.proxyCall(_this.contract.methods.getSellTokenAmount, BaseWrapper_1.tupleParser(BaseWrapper_1.valueToString, BaseWrapper_1.identity), BaseWrapper_1.valueToBigNumber);
        /**
