...
export declare class ElectionWrapper extends BaseWrapper<Election> {
     ...
     */
    getCurrentValidatorSigners(blockNumber?: number): Promise<Address[]>;
    /**
     ...
     */
    electValidatorSigners: () => Promise<string[]>;
    /**
    ...
    _activate: (group: string) => CeloTransactionObject<boolean>;
    /**
     ...
     */
    getVoterRewards(address: Address, epochNumber: number): Promise<VoterReward[]>;
}
