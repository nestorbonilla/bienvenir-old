...
export declare class IdentityMetadataWrapper {
    ...
    static fetchFromURL(url: string): Promise<IdentityMetadataWrapper>;
    static fromFile(path: string): IdentityMetadataWrapper;
    static fromRawString(rawData: string): IdentityMetadataWrapper;
    ...
    hashOfClaims(): string;
    toString(): string;
    addClaim(claim: Claim, signer: Signer): Promise<void>;
